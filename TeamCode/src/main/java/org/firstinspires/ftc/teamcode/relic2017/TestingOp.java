...
//import evlib.hardware.sensors.SpikeDetector;
...
//import org.firstinspires.ftc.teamcode.relic2017.Sparky2017.OptionsOp;
...
//
//public class TestingOp extends AbstractAutoOp<RobotCfg2017> {
...
//        LEFT_SECOND_LINE,
//        RIGHT_SECOND_LINE,
//        MOVE_TILL_RIGHT, MOVE_TILL_LEFT, MOVE_TOWARD_LINE, CALIBRATE_LINE_SENSORS, TURN_LITTLE, WAIT_FOR_LINE_SENSORS, MOVE_LEFT
//
//
//
//
...
//
//        final SpikeDetector intialLineSensor = isRed ? robotCfg.getLeftLineSensor() : robotCfg.getRightLineSensor();
...
//
//        EVStateMachineBuilder b = robotCfg.createEVStateMachineBuilder(S.SERVO_INIT, teamColor, Angle.fromDegrees(2));
//        b.addServoInit(S.SERVO_INIT,S.WAIT_FOR_GYRO_CALIBRATION);
//        b.addStop(S.WAIT_FOR_GYRO_CALIBRATION);
////        b.addCalibrateGyro(S.WAIT_FOR_GYRO_CALIBRATION,S.CALIBRATE_LINE_SENSORS);
...
////                return S.WAIT_FOR_LINE_SENSORS;
////            }
////        });
//////        b.addGyroTurn(S.TURN_LITTLE,S.GRAB_LEFT_BLOCK,-5);
...
////
////        ),.5,firstMoveDirection,firstMoveOrientation);
...
////
////
////        ),.5,secondMoveDirection,firstMoveOrientation);
...
////            }
////        });
////        b.addServo(S.SENSOR_SERVO_DOWN,S.GRAB_RIGHT_BLOCK,RobotCfg2017.MainServoName.SENSOR, RobotCfg2017.SensorServoPresets.DOWN,.7,true);
...
////        b.addServo(S.GRAB_LEFT_BLOCK,S.FIND_JEWEL_COLOR,RobotCfg2017.MainServoName.LEFTRELEASE,RobotCfg2017.LeftReleaseServoPresets.GRAB,1.5,true);
////
...
////            }
////        });
////        b.addCount(S.NO_JEWEL,S.MOVE_JEWEL_LITTLE_UP,S.TURN_LITTLE,2);
////        b.addGyroTurn(S.TURN_LITTLE,S.SENSOR_SERVO_UP,1.5);
...
////        b.addGyroTurn(S.HIT_LEFT,S.SENSOR_SERVO_UP,5);
////        b.addGyroTurn(S.HIT_RIGHT,S.SENSOR_SERVO_UP,-5);
////        b.addServo(S.SENSOR_SERVO_UP,S.TURN_TO_BOX,RobotCfg2017.MainServoName.SENSOR,RobotCfg2017.SensorServoPresets.UP,false);
////        b.addGyroTurn(S.TURN_TO_BOX,S.MOVE_TOWARD_LINE,firstMoveOrientation);
////        b.addDrive(S.MOVE_TOWARD_LINE, S.CALIBRATE_LINE_SENSORS, Distance.fromFeet(1.5),.75,firstMoveDirection,firstMoveOrientation);
////        b.add(S.CALIBRATE_LINE_SENSORS, new BasicAbstractState() {
////            @Override
////            public void init() {
////                leftLineSensor.resetSensor();
...
////                ,S.TIMOUT_LINE,EVEndConditions.timed(Time.fromSeconds(5))
////
////        ),.75,firstMoveDirection,firstMoveOrientation);
////        b.addDrive(S.FIRST_LINE, StateMap.of(
////                // S.SECOND_LINE,EVEndConditions.any(ImmutableList.of(EVEndConditions.digitalSensor(intialLineSensor))),
////                S.LEFT_SECOND_LINE,EVEndConditions.digitalSensor(leftLineSensor),
////                S.RIGHT_SECOND_LINE,EVEndConditions.digitalSensor(rightLineSensor)
...
////
////
////        b.addStop(S.SENSOR_SERVO_UP);
////        b.addStop(S.MOVE_RIGHT);
////        b.addStop(S.MOVE_LEFT);
//        b.addStop(S.GRAB_LEFT_BLOCK);
////
////
////
////
...
//        telemetry.addData("leftLineValue",robotCfg.getLeftLineSensor().getValue());
//        telemetry.addData("leftLong",robotCfg.getLeftLineSensor().getLongAverage());
//        telemetry.addData("leftRaw",robotCfg.getLeftLineSensor().getRawSensor().getValue());
//        telemetry.addData("rightLineValue",robotCfg.getRightLineSensor().getValue());
//        telemetry.addData("rightlongAverage",robotCfg.getRightLineSensor().getLongAverage());
//        telemetry.addData("rightRaw",robotCfg.getRightLineSensor().getRawSensor().getValue());
//        telemetry.addData("ready",robotCfg.getLeftLineSensor().isReady());
//        telemetry.addData("lspiking",robotCfg.getLeftLineSensor().isSpiking());
//        telemetry.addData("rspiking",robotCfg.getRightLineSensor().isSpiking());
//
