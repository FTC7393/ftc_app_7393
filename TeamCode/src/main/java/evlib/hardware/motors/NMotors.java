...
public class NMotors {
     ...
     */
    private final List<? extends evlib.hardware.motors.Motor> motors;
     ...
     */
    public NMotors(List<? extends evlib.hardware.motors.Motor> motors, boolean useSpeedMode, Velocity maxRobotSpeed) {
