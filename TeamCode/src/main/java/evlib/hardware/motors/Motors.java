 ...
 *
 * @see evlib.hardware.motors.Motor
 * @see MotorEnc
 */
public class Motors {
    /**
     ...
     */
    public static InputExtractor<Double> powerIE(final evlib.hardware.motors.Motor motor) {
     ...
     * @return the created InputExtractor
     */
    public static InputExtractor<evlib.hardware.motors.Motor.Mode> modeIE(final evlib.hardware.motors.Motor motor) {
        return new InputExtractor<evlib.hardware.motors.Motor.Mode>() {
            @Override
            public evlib.hardware.motors.Motor.Mode getValue() {
     ...
     */
    public static evlib.hardware.motors.Motor combinedWithoutEncoder(evlib.hardware.motors.Motor motor1, evlib.hardware.motors.Motor motor2) {
     ...
     */
    public static evlib.hardware.motors.Motor combinedWithoutEncoder(final Collection<evlib.hardware.motors.Motor> motors) {
        return new evlib.hardware.motors.Motor() {
            @Override
            public void setPower(double power) {
                for (evlib.hardware.motors.Motor motor : motors) motor.setPower(power);
            }
            ...
            @Override
            public void update() {
                for (evlib.hardware.motors.Motor motor : motors) motor.update();
            }
        };
    }
     ...
     */
    public static evlib.hardware.motors.Motor withoutEncoder(HardwareMap hardwareMap, String dcMotorName, boolean reversed, boolean brake, Stoppers stoppers) {
     ...
     * @return the created MotorEnc
     */
    public static evlib.hardware.motors.Motor withoutEncoder(final DcMotor dcMotor, boolean reversed, boolean brake, Stoppers stoppers) {
     ...
     */
    public static DcMotor.RunMode motorModeToDcMotorRunMode(evlib.hardware.motors.Motor.Mode mode) {
        switch (mode) {
            case POWER:
     ...
     */
    public static evlib.hardware.motors.Motor.Mode dcMotorRunModeToMotorMode(DcMotor.RunMode runMode) {
        switch (runMode) {
            case RUN_WITHOUT_ENCODER:
                return evlib.hardware.motors.Motor.Mode.POWER;
            case RUN_USING_ENCODER:
                return evlib.hardware.motors.Motor.Mode.SPEED;
            case RUN_TO_POSITION:
                return evlib.hardware.motors.Motor.Mode.POSITION;
            default:
                return null;
        }
    }
    ...
    public static MotorEnc withEncoder(final DcMotor dcMotor, boolean reversed, boolean brake, Stoppers stoppers) {
        final evlib.hardware.motors.Motor.Mode initMode = evlib.hardware.motors.Motor.Mode.SPEED;
...
//        } while (dcMotor.getMaxSpeed() != maxEncoderTicksPerSecond);
     ...
     */
    public static evlib.hardware.motors.Motor continuousServo(final CRServo crServo, boolean reversed) {
     ...
     * @return the created MotorEnc
     */
    public static evlib.hardware.motors.Motor scale(final evlib.hardware.motors.Motor motor, final double scale) {
        return new evlib.hardware.motors.Motor() {
            @Override
            public void setPower(double power) {
     ...
     * @return the created MotorEnc
     */
    public static evlib.hardware.motors.Motor scale(final evlib.hardware.motors.Motor motor, final Function function) {
        return new evlib.hardware.motors.Motor() {
            private double power = 0;
     ...
     * @return the created MotorEnc
     */
    public static evlib.hardware.motors.Motor scale(final MotorEnc motorEnc, final Function function) {
        return new MotorEnc() {
            private double power = 0;
     ...
     */
    public static evlib.hardware.motors.Motor dummyWithoutEncoder() {
        return new evlib.hardware.motors.Motor() {
            @Override
            public void setPower(double power) {
