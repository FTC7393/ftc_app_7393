 ...
 */
public class ThreeMotors extends evlib.hardware.motors.NMotors {
    public ThreeMotors(evlib.hardware.motors.Motor motor1, evlib.hardware.motors.Motor motor2, Motor motor3, boolean useSpeedMode, Velocity maxRobotSpeed) {
