 ...
 *
 * @see evlib.hardware.motors.FourMotors
 * @see evlib.hardware.control.MecanumControl
 */
public class MecanumMotors extends evlib.hardware.motors.FourMotors {
     ...
     */
    public MecanumMotors(evlib.hardware.motors.Motor frontLeftMotor, evlib.hardware.motors.Motor frontRightMotor, evlib.hardware.motors.Motor backLeftMotor, Motor backRightMotor, boolean useSpeedMode, Velocity maxRobotSpeed, Velocity maxRobotSpeedSideways) {
