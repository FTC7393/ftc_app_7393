 ...
 *
 * @see evlib.hardware.motors.Stopper
 */
...
public class Stoppers {
     ...
     */
    private final Set<evlib.hardware.motors.Stopper> stoppers = new HashSet<>();
     ...
     */
    public Stoppers(Collection<evlib.hardware.motors.Stopper> stoppers) {
     ...
     */
    public void add(evlib.hardware.motors.Stopper stopper) {
     ...
     */
    public void stop() {
        for (evlib.hardware.motors.Stopper stopper : stoppers) {
            stopper.stop();
        }
    }
}
