 ...
 */
public class AveragedSensor implements evlib.hardware.sensors.AnalogSensor {
     ...
     */
    public AveragedSensor(evlib.hardware.sensors.AnalogSensor sensor, int numReadings) {
        this.sensor = sensor;
