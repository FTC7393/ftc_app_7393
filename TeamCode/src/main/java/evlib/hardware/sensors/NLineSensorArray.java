 ...
 */
public class NLineSensorArray implements evlib.hardware.sensors.LineSensorArray {
    private final List<evlib.hardware.sensors.LineSensorArray> lineSensorArrays;
    ...
    public NLineSensorArray(List<evlib.hardware.sensors.LineSensorArray> lineSensorArrays) {
        this.lineSensorArrays = lineSensorArrays;
        int numSensors1 = 0;

        for (evlib.hardware.sensors.LineSensorArray lineSensorArray : lineSensorArrays) {
