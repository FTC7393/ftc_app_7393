 ...
 * @see evlib.hardware.sensors.DigitalSensor
 */
public class DoubleLineSensor implements evlib.hardware.sensors.DigitalSensor {
    ...
    public DoubleLineSensor(evlib.hardware.sensors.AnalogSensor leftSensor, AnalogSensor rightSensor) {
