 ...
 */
public class FilteredLineSensorArray implements evlib.hardware.sensors.LineSensorArray {
    private final evlib.hardware.sensors.LineSensorArray lineSensorArray;
    ...
    public FilteredLineSensorArray(evlib.hardware.sensors.LineSensorArray lineSensorArray) {
