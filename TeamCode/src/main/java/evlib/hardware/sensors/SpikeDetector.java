...
public class SpikeDetector implements evlib.hardware.sensors.DigitalSensor {

    private final evlib.hardware.sensors.AnalogSensor sensor;
     ...
     */
    public SpikeDetector(evlib.hardware.sensors.AnalogSensor sensor, double spikeThreshold, int numLongReadings, int numShortReadings) {
