 ...
 *
 * @see evlib.hardware.sensors.AnalogSensor
 */
public class CalibratedLineSensor implements evlib.hardware.sensors.DigitalSensor {
    private boolean ready = true;
    private final evlib.hardware.sensors.AnalogSensor lineSensor;
     ...
     */
    public CalibratedLineSensor(evlib.hardware.sensors.AnalogSensor lineSensor) {
