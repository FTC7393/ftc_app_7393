 ...
 *
 * @see Servo
 * @see evlib.hardware.servos.ServoName
 * @see evlib.hardware.servos.ServoCfg
 */
public class ServoControl {
    ...
    private final evlib.hardware.servos.ServoName name;
     ...
     */
    public ServoControl(Servo servo, evlib.hardware.servos.ServoName name, Enum startPreset) {
        this.servo = servo;
        this.name = name;

        OptionsFile optionsFile = new OptionsFile(EVConverters.getInstance(), evlib.hardware.servos.ServoCfg.getServoFile(name));
