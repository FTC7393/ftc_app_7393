...
public class PositionTracker {
    private final evlib.hardware.control.MecanumControl mecanumControl;
    ...
    public PositionTracker(evlib.hardware.control.MecanumControl mecanumControl, GyroSensor gyro) {
