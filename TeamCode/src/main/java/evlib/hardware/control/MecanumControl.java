...
public class MecanumControl {
    ...
    public MecanumControl(MecanumMotors mecanumMotors) {
        this(mecanumMotors, evlib.hardware.control.XYRControls.ZERO);
    }
     ...
     */
    public MecanumControl(MecanumMotors mecanumMotors, evlib.hardware.control.XYRControl xyrControl) {
