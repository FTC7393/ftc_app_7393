package evlib.hardware.control;
 ...
 *
 * @see evlib.hardware.control.TranslationControl
 */
...
public class TranslationControls {
     ...
     * No movement
     */
    public static final evlib.hardware.control.TranslationControl ZERO = constant(0, Angle.zero());

    public static evlib.hardware.control.TranslationControl constant(final Vector2D vector2D) {
        return new evlib.hardware.control.TranslationControl() {
            @Override
            public boolean act() {
                return true;
            }
     ...
     */
    public static evlib.hardware.control.TranslationControl constant(double velocity, Angle direction) {
    ...
    public static evlib.hardware.control.TranslationControl inputExtractorPolarDegrees(final InputExtractor<Double> velocity, final InputExtractor<Double> directionDegrees) {
        return new evlib.hardware.control.TranslationControl() {
            @Override
            public boolean act() {
                return true;
    ...
    public static evlib.hardware.control.TranslationControl inputExtractorPolar(final InputExtractor<Double> velocity, final InputExtractor<Angle> direction) {
        return new evlib.hardware.control.TranslationControl() {
            @Override
            public boolean act() {
                return true;
    ...
    public static evlib.hardware.control.TranslationControl inputExtractorXY(final InputExtractor<Double> velocityX, final InputExtractor<Double> velocityY) {
        return new evlib.hardware.control.TranslationControl() {
    ...
    public static evlib.hardware.control.TranslationControl inputExtractorXY(final InputExtractor<Vector2D> vector2D) {
        return new evlib.hardware.control.TranslationControl() {
    ...
    public static evlib.hardware.control.TranslationControl lineFollow(final LineSensorArray lineSensorArray, final LineFollowDirection direction, final double center, final double velocity) {
        return new evlib.hardware.control.TranslationControl() {
            @Override
            public boolean act() {
...
//    }
     ...
     * @return the created TranslationControl
     */
    public static evlib.hardware.control.TranslationControl lineFollow(final DoubleLineSensor doubleLineSensor, final LineFollowDirection lineFollowDirection, final double velocity) {
