 ...
 *
 * @see evlib.hardware.control.RotationControl
 */
...
public class RotationControls {
     ...
     * No movement
     */
    public static final evlib.hardware.control.RotationControl ZERO = constant(0);
     ...
     */
    public static evlib.hardware.control.RotationControl constant(final double velocityR) {
        return new evlib.hardware.control.RotationControl() {
            @Override
            public boolean act() {
                return true;
            }
     ...
     * @return the created RotationControl
     */
    public static evlib.hardware.control.RotationControl inputExtractor(final InputExtractor<Double> rotation) {
        return new evlib.hardware.control.RotationControl() {
            @Override
            public boolean act() {
                return true;
    ...
    public static evlib.hardware.control.RotationControl gyro(Gyro gyro, Angle targetHeading, Angle tolerance) {
        return gyro(gyro, targetHeading, tolerance, evlib.hardware.control.RotationControl.DEFAULT_MAX_ANGULAR_SPEED);
    }
...
//                telemetry.addData("rotationCorrection", rotationCorrection);
     ...
     * @return the created RotationControl
     */
    public static evlib.hardware.control.RotationControl teleOpGyro(InputExtractor<Double> driver, Gyro gyro, Angle tolerance) {
        return teleOpGyro(driver, gyro, tolerance, evlib.hardware.control.RotationControl.DEFAULT_MAX_ANGULAR_SPEED);
    }
     ...
     * @return the created RotationControl
     */
    public static evlib.hardware.control.RotationControl teleOpGyro(final InputExtractor<Double> driver, final Gyro gyro, final Angle tolerance, final double maxAngularSpeed) {
       ...
       // gyro.calibrate();
        ...
        return new evlib.hardware.control.RotationControl() {
            ...
            private evlib.hardware.control.RotationControl gyroControl;
