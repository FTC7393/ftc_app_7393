 ...
 *
 * @see evlib.hardware.control.XYRControl
 */
...
public class XYRControls {
     ...
     * No movement
     */
    public static final evlib.hardware.control.XYRControl ZERO = constant(0, Angle.zero(), 0);
...
//    }
     ...
     */
    public static evlib.hardware.control.XYRControl constant(double velocity, Angle direction, final double rotation) {
        final Vector2D vector2D = new Vector2D(velocity, direction);

        return new evlib.hardware.control.XYRControl() {
            @Override
            public boolean act() {
                return true;
            }
     ...
     * @return the created XYRControl
     */
    public static evlib.hardware.control.XYRControl inputExtractorPolarDegreesR(final InputExtractor<Double> velocity, final InputExtractor<Double> directionDegrees, final InputExtractor<Double> rotation) {
        return new evlib.hardware.control.XYRControl() {
            @Override
            public boolean act() {
                return false;
     ...
     * @return the created XYRControl
     */
    public static evlib.hardware.control.XYRControl inputExtractorPolarR(final InputExtractor<Double> velocity, final InputExtractor<Angle> direction, final InputExtractor<Double> rotation) {
        return new evlib.hardware.control.XYRControl() {
            @Override
            public boolean act() {
                return false;
     ...
     * @return the created XYRControl
     */
    public static evlib.hardware.control.XYRControl inputExtractorXYR(final InputExtractor<Double> velocityX, final InputExtractor<Double> velocityY, final InputExtractor<Double> velocityR) {
        return new evlib.hardware.control.XYRControl() {
            @Override
            public boolean act() {
                return false;
     ...
     * @return the created XYRControl
     */
    public static evlib.hardware.control.XYRControl inputExtractorXYR(final InputExtractor<Vector2D> velocityXY, final InputExtractor<Double> velocityR) {
        return new evlib.hardware.control.XYRControl() {
            @Override
            public boolean act() {
                return false;
