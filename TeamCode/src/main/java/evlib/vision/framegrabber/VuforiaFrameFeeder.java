...
import evlib.vision.processors.BeaconName;
 ...
 *
 * @see evlib.vision.framegrabber.GlobalFrameGrabber
...
//        VuforiaLocalizer.Parameters params = new VuforiaLocalizer.Parameters();
    ...
    public VuforiaFrameFeeder(Parameters params, int widthRequest, int heightRequest) {
        this(params, widthRequest, heightRequest, evlib.vision.framegrabber.FrameGrabber.CameraOrientation.PORTRAIT_UP, false);
    }

    public VuforiaFrameFeeder(Parameters params, evlib.vision.framegrabber.FrameGrabber.CameraOrientation cameraOrientation, int widthRequest, int heightRequest) {
    ...
    public VuforiaFrameFeeder(Parameters params, boolean ignoreOrientationForDisplay, int heightRequest, int widthRequest) {
        this(params, widthRequest, heightRequest, evlib.vision.framegrabber.FrameGrabber.CameraOrientation.PORTRAIT_UP, ignoreOrientationForDisplay);
    }
