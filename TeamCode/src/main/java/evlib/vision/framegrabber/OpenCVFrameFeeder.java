package evlib.vision.framegrabber;
 ...
 * @see evlib.vision.framegrabber.RealFrameGrabber
 */
public class OpenCVFrameFeeder implements CameraBridgeViewBase.CvCameraViewListener2 {
    ...
    private final evlib.vision.framegrabber.FrameGrabber.CameraOrientation cameraOrientation;
    ...
    public OpenCVFrameFeeder(CameraBridgeViewBase cameraBridgeViewBase, int frameWidthRequest, int frameHeightRequest) {
        this(cameraBridgeViewBase, frameWidthRequest, frameHeightRequest, evlib.vision.framegrabber.FrameGrabber.CameraOrientation.PORTRAIT_UP, false);
    }

    public OpenCVFrameFeeder(CameraBridgeViewBase cameraBridgeViewBase, int frameWidthRequest, int frameHeightRequest, evlib.vision.framegrabber.FrameGrabber.CameraOrientation cameraOrientation) {
    ...
    public OpenCVFrameFeeder(CameraBridgeViewBase cameraBridgeViewBase, int frameWidthRequest, int frameHeightRequest, boolean ignoreOrientationForDisplay) {
        this(cameraBridgeViewBase, frameWidthRequest, frameHeightRequest, evlib.vision.framegrabber.FrameGrabber.CameraOrientation.PORTRAIT_UP, ignoreOrientationForDisplay);
    }

    public OpenCVFrameFeeder(CameraBridgeViewBase cameraBridgeViewBase, int frameWidthRequest, int frameHeightRequest, evlib.vision.framegrabber.FrameGrabber.CameraOrientation cameraOrientation, boolean ignoreOrientationForDisplay) {
