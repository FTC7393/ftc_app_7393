 ...
 *
 * @see evlib.vision.framegrabber.FrameGrabber
...
public class GlobalFrameGrabber {
     ...
     */
    public static evlib.vision.framegrabber.FrameGrabber frameGrabber = new evlib.vision.framegrabber.FrameGrabber() {
