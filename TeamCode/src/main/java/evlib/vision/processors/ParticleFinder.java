 ...
 */
public class ParticleFinder implements evlib.vision.processors.ImageProcessor<List<evlib.vision.processors.Particle>> {
...
//    private static String[] colorNames = {"red", "green", "blue"};
    ...
    private static final evlib.vision.processors.Particle.Color[] PARTICLE_COLORS = {evlib.vision.processors.Particle.Color.RED, evlib.vision.processors.Particle.Color.BLUE};

    private final StepTimer stepTimer = new StepTimer(TAG, Log.INFO);

    @Override
    public ImageProcessorResult<List<evlib.vision.processors.Particle>> process(long startTime, Mat rgbaFrame, boolean saveImages) {
...
//        thresholdMax.add(new Scalar((60) / 2, 255, 255));
        ...
        List<evlib.vision.processors.Particle> particles = new ArrayList<>();
