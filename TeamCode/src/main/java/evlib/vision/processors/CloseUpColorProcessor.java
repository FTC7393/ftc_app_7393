 ...
 */
public class CloseUpColorProcessor implements evlib.vision.processors.ImageProcessor<evlib.vision.processors.BeaconColorResult.BeaconColor> {
     ...
     */
    @Override
    public evlib.vision.processors.ImageProcessorResult<evlib.vision.processors.BeaconColorResult.BeaconColor> process(long startTime, Mat rgbaFrame, boolean saveImages) {
