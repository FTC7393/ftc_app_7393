 ...
 */
public class RedBlueBeaconProcessor implements evlib.vision.processors.ImageProcessor<evlib.vision.processors.BeaconColorResult> {
...
//        Arrays.fill(centerOfMass, Double.MIN_VALUE);
        ...
        evlib.vision.processors.BeaconColorResult.BeaconColor left = evlib.vision.processors.BeaconColorResult.BeaconColor.UNKNOWN;
        evlib.vision.processors.BeaconColorResult.BeaconColor right = evlib.vision.processors.BeaconColorResult.BeaconColor.UNKNOWN;
        ...
        if (centerOfMass[0] != Double.MIN_VALUE && centerOfMass[2] != Double.MIN_VALUE && Math.abs(difference) >= MIN_CM_DIFF) {
            ...
            if (difference > 0) {
                left = evlib.vision.processors.BeaconColorResult.BeaconColor.RED;
                right = evlib.vision.processors.BeaconColorResult.BeaconColor.BLUE;
            } else {
                left = evlib.vision.processors.BeaconColorResult.BeaconColor.BLUE;
                right = evlib.vision.processors.BeaconColorResult.BeaconColor.RED;
            }
        }
