package evlib.vision.processors;
...
import evlib.vision.ImageUtil;
import evlib.vision.framegrabber.VuforiaFrameFeeder;

import static evlib.vision.framegrabber.VuforiaFrameFeeder.beacons;
...
public class VuforiaBeaconColorProcessor implements evlib.vision.processors.ImageProcessor<evlib.vision.processors.BeaconColorResult> {
    private static final String TAG = "VuforiaBeaconColor";
    private final VuforiaFrameFeeder vuforia;
    private final evlib.vision.processors.RedBlueBeaconProcessor beaconProcessor = new RedBlueBeaconProcessor(50, 100); //(5, 25); //(15, 15); //(51, 76);
    private int resultsFound = 0;
    private final List<evlib.vision.processors.BeaconColorResult> results = new ArrayList<>();
    ...
    private evlib.vision.processors.BeaconName beaconName = evlib.vision.processors.BeaconName.WHEELS;
    ...
    public evlib.vision.processors.BeaconColorResult getAverageResult() {
        //TODO simplify VuforiaBeaconColorProcessor.getAverageResult()
        Map<evlib.vision.processors.BeaconColorResult.BeaconColor, Integer> leftColors = new HashMap<>();
        Map<evlib.vision.processors.BeaconColorResult.BeaconColor, Integer> rightColors = new HashMap<>();

        for (evlib.vision.processors.BeaconColorResult result : results) {
            evlib.vision.processors.BeaconColorResult.BeaconColor leftColor = result.getLeftColor();
            evlib.vision.processors.BeaconColorResult.BeaconColor rightColor = result.getRightColor();
            int num = 0;
        ...
        int leftMax = 0;
        evlib.vision.processors.BeaconColorResult.BeaconColor leftMaxColor = evlib.vision.processors.BeaconColorResult.BeaconColor.UNKNOWN;
        for (Map.Entry<evlib.vision.processors.BeaconColorResult.BeaconColor, Integer> entry : leftColors.entrySet()) {
            evlib.vision.processors.BeaconColorResult.BeaconColor color = entry.getKey();
        ...
        int rightMax = 0;
        evlib.vision.processors.BeaconColorResult.BeaconColor rightMaxColor = evlib.vision.processors.BeaconColorResult.BeaconColor.UNKNOWN;
        for (Map.Entry<evlib.vision.processors.BeaconColorResult.BeaconColor, Integer> entry : rightColors.entrySet()) {
            evlib.vision.processors.BeaconColorResult.BeaconColor color = entry.getKey();
            int quantity = entry.getValue();
        ...
        return new evlib.vision.processors.BeaconColorResult(leftMaxColor, rightMaxColor);
    }

    @Override
    public evlib.vision.processors.ImageProcessorResult<evlib.vision.processors.BeaconColorResult> process(long startTime, Mat rgbaFrame, boolean saveImages) {
...
//        Log.i(TAG, beacon.getName());
        ...
        if (pose == null) {
            return new evlib.vision.processors.ImageProcessorResult<>(startTime, rgbaFrame, new evlib.vision.processors.BeaconColorResult());
        }
