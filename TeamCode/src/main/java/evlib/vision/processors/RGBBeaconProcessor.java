 ...
 */
public class RGBBeaconProcessor implements evlib.vision.processors.ImageProcessor<evlib.vision.processors.BeaconResult> {
...
//    Imgproc.line(rgbaFrame, p1, p2, ImageUtil.BLACK, THICKNESS);
        ...
        evlib.vision.processors.BeaconColorResult.BeaconColor[] beaconColors = evlib.vision.processors.BeaconColorResult.BeaconColor.values();
        evlib.vision.processors.BeaconColorResult.BeaconColor left = beaconColors[maxIndex[0]];
        evlib.vision.processors.BeaconColorResult.BeaconColor right = beaconColors[maxIndex[1]];
