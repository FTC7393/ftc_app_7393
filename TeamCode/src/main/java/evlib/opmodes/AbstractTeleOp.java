package evlib.opmodes;

import ftc.electronvolts.util.Function;
import ftc.electronvolts.util.Functions;
import ftc.electronvolts.util.units.Time;
import evlib.driverstation.GamepadManager;
 ...
 *
 * @see evlib.opmodes.AbstractOp
 * @see GamepadManager
 */
public abstract class AbstractTeleOp<Type extends RobotCfg> extends evlib.opmodes.AbstractOp<Type> {
